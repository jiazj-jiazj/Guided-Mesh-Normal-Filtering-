...
namespace MeshN { 
	...
	public:
		...
		void  adjustFaceNormal_2015();

		double count_K(Normal normal_1, Normal normal_2, double egama); //计算核函数值，传入两个向量，一个核参数

		void Guided_Mesh_Normal_Filtering_2015();/////////////////////////////////////////////////实现一种三角网格去噪算法 2015年引导双边滤波
